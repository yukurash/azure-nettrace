...
<picture>
  ...
  <img alt="到達性レポート: 結論バンド・配線図・ブロッカー件数" src="docs/images/report-overview-light.png">
</picture>
...
<picture>
  ...
  <img alt="NSG ノードをクリックするとセキュリティ規則のインスペクタが開く" src="docs/images/report-inspect-light.png">
</picture>
